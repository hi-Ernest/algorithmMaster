...
public class TreeTraversal {
    ...
    public TreeNode buildTree(
            Queue<Integer> preorderQueue, int left, int right, Map<Integer, Integer> inorderIdxMap) {
    ...
    public TreeNode buildTree_2(int[] postorder, int[] inorder) {
        ...
        return buildTree(
                postorderStack, 0, postorder.length - 1, inorderIdxMap);
    }

    public TreeNode buildTree(
            Stack<Integer> postorderStack, int left, int right, Map<Integer, Integer> inorderIdxMap) {
